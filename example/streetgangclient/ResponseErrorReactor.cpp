...
ResponseErrorReactor::ResponseErrorReactor(std::shared_ptr<Connection> connection, std::shared_ptr<ResponseError> message, std::shared_ptr<StreetGangRequester> requester)
