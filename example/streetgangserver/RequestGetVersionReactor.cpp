...
RequestGetVersionReactor::RequestGetVersionReactor(std::shared_ptr<Connection> connection, std::shared_ptr<RequestGetVersion> message, std::shared_ptr<StreetGangResponder> responder)
